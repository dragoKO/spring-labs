...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("balanceManager.checkout(customerBalance,new BigDecimal(80)) = " + balanceManager.checkout(customerBalance, new BigDecimal(80)));
        System.out.println("balanceManager.checkout(giftCardBalance,new BigDecimal(120)) = " + balanceManager.checkout(giftCardBalance, new BigDecimal(120)));
